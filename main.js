...
const experienceData = {
  'director': {
    ...
    description: 'Oversaw maintenance, space planning, and daily operations for campus facilities.',
    bullets: [
      'Implemented process improvements to enhance service quality',
      'Led initiatives supporting campus programs and facilities management',
      'Managed facility maintenance and space allocation',
      'Coordinated with various departments for optimal resource utilization'
    ]
  },
  'outreach': {
    id: 'outreach',
    ...
    description: 'Developed partnerships with academic and industry stakeholders to enhance student opportunities.',
    bullets: [
      'Coordinated events and workshops for student development',
      'Increased student engagement through strategic outreach',
      'Fostered relationships with industry professionals',
      'Organized networking events and career development programs'
    ]
  },
  'operations': {
    id: 'operations',
    ...
    description: 'Maintained facility safety and cleanliness while providing excellent guest support.',
    bullets: [
      'Provided excellent guest support and policy enforcement',
      'Improved guest experiences through proactive service',
      'Maintained facility safety standards and cleanliness',
      'Assisted with facility operations and member services'
    ]
  },
  'teaching': {
    id: 'teaching',
    ...
    bullets: [
      ...
      'Assisted in course administration and student support',
...
function createSectionHeader(title) {
  ...
  switch (title) {
    ...
    case 'Experience':
      ...
      break;
    case 'Contact':
      p.textContent = 'Get in touch with me for opportunities and collaborations.';
      break;
  }
    ...
    <div class="hero-content">
      <div class="hero-text">
        ...
        <div class="hero-buttons">
          <a href="MalharKansara_Resume_CS.pdf" download class="btn btn-primary">
            📄 Download Resume
          </a>
...
function renderExperienceList(parentElement) {
  ...
  // Iterate through experience hash map to render each experience
